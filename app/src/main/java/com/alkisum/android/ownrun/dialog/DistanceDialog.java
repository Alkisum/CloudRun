...
public class DistanceDialog extends DialogFragment {
    ...
    public final Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        final NumberPicker nbInteger = ButterKnife.findById(
                view, R.id.distance_nb_integer);
        nbInteger.setMinValue(0);
        nbInteger.setMaxValue(99);
        int integerPart = (int) (distance / 1000f);
        nbInteger.setValue(integerPart);
        final NumberPicker nbFractional = ButterKnife.findById(
                view, R.id.distance_nb_fractional);
