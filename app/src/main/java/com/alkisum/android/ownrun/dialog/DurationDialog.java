...
public class DurationDialog extends DialogFragment {
    ...
    public final Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        final NumberPicker nbHour = ButterKnife.findById(
                view, R.id.duration_nb_hour);
        nbHour.setMinValue(0);
        nbHour.setMaxValue(23);
        nbHour.setValue(hour);
        final NumberPicker nbMinute = ButterKnife.findById(
                view, R.id.duration_nb_minute);
        nbMinute.setMinValue(0);
        nbMinute.setMaxValue(59);
        nbMinute.setValue(minute);
        final NumberPicker nbSecond = ButterKnife.findById(
                view, R.id.duration_nb_second);
